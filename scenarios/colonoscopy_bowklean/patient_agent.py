# modules/colonoscopy_bowelprep_A/patient_agent.py
import logging
...
def build_patient_prompt(user_text: str, history: str, agent_settings_dict: Dict, precomputed_data_dict: Optional[Dict] = None) -> str:
    """
    ...
    if precomputed_data_dict:
        ...
        logger.warning("Precomputed data not available for patient agent prompt. Using dynamic calculation.")
