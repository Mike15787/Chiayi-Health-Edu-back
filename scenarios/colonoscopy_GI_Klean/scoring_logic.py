# scenarios/colonoscopy_GI_Klean/scoring_logic.py
import json
import logging
import numpy as np
import faiss
...
from scenarios.colonoscopy_GI_Klean.config import (
    MODULE_ID,
...
from scenarios.colonoscopy_GI_Klean.summary_logic import (
